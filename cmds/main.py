...
class Main(Cog_Extension):
    ...
    async def help(self, ctx):
        ...
        embed.add_field(name="5. Load", value="導入類別\n用法: `-load [類別]`", inline=False)
        embed.add_field(name="6. Reload", value="重新導入類別\n用法: `-reload [類別]`", inline=False)
        embed.add_field(name="7. Unload", value="導出類別\n用法: `-unload [類別]`", inline=False)
        embed.add_field(name="8. Rock Peper Scissor", value="和機器人用剪刀石頭布一決勝負\n用法: `-rps`", inline=False)
        embed.add_field(name="9. Guess Number", value="猜數字遊戲\n用法: `-gn`", inline=False)
        embed.add_field(name="10. Choose", value="讓機器人幫你選擇\n用法: `-choose [選擇]`", inline=False)
